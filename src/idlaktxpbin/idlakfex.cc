...
int main(int argc, char *argv[]) {
  const char *usage =
      ...
      "e.g.: ./idlaktxp --pretty --tpdb=../../idlak-data/en/ga ../idlaktxp/testdata/mod-syllabify-out002.xml output.xml\n" //NOLINT
      "e.g.: cat  ../idlaktxp/testdata/mod-syllabify-out002.xml output.xml | idlaktxp --pretty --tpdb=../../idlak-data/en/ga - - > output.xml\n"; //NOLINT
