// idlaktxp/fexfunctionscatalog.cc
...
const enum FEXSPECPAU_TYPE FEXFUNCPAUTYPE[] = {FEXSPECPAU_TYPE_PRE, FEXSPECPAU_TYPE_PRE, FEXSPECPAU_TYPE_CUR, FEXSPECPAU_TYPE_PST, FEXSPECPAU_TYPE_PST};
...
//       fex-default.xml
const enum FEXSPEC_TYPE FEXFUNCTYPE[] = {FEXSPEC_TYPE_STR, FEXSPEC_TYPE_STR, FEXSPEC_TYPE_STR, FEXSPEC_TYPE_STR, FEXSPEC_TYPE_STR};
