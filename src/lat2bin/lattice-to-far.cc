...
// Copyright 2014 Paul Dixon paul.r.dixon@gmail.com
...
//Scalar weight 
void ConvertToFst(const CompactLattice &clat, MutableFst<LatticeArc> *lat) {
...
struct LatticeToFarOpts {
  LatticeToFarOpts() : 
    acoustic_scale(0.0f), lm_scale(0.0f), rm_eps(false) { }
