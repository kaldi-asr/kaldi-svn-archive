...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Copy neural network-based acoustic model (of type nnet1).\n"
        "Usage:  nnet1-copy [options] <nnet1-in> <nnet1-out>\n"
        "e.g.:\n"
        " nnet1-copy --binary=false 1.nnet1 tmp.txt\n";
