...
const char * const FEXFUNCLBL[] = {"p", "bp"};

const fexfunction FEXFUNC[] = {&FexFuncCURSTRp, &FexFuncPRESTRbp};
...
const enum FEXPAU_TYPE FEXFUNCPAUTYPE[] = {FEXPAU_TYPE_CUR, FEXPAU_TYPE_PRE};
...
//       fex-default.xml
const enum FEX_TYPE FEXFUNCTYPE[] = {FEX_TYPE_STR, FEX_TYPE_STR};
