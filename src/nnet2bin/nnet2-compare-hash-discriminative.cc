...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "This program was created as a way of testing nnet2-get-egs-discriminative\n"
        "The model is only needed for its transition-model.\n"
        "\n"
        "Usage:  nnet2-compare-hash-discriminative [options] <model-rxfilename> "
        "<egs-rspecifier1> <egs-rspecifier2>\n"
        "\n"
        "Note: options --drop-frames and --criterion should be matched with the\n"
        "command line of nnet2-get-egs-discriminative used to get the examples\n"
