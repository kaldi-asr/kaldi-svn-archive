...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "them using the --stats-from option of nnet2-am-copy before you use.\n"
        "this program.\n"
        "\n"
        "Usage:  nnet2-am-fix [options] <nnet-in> <nnet-out>\n"
        "e.g.:\n"
        " nnet2-am-fix 1.mdl 1_fixed.mdl\n"
        "or:\n"
        " nnet2-am-fix --get-counts-from=1.gradient 1.mdl 1_shrunk.mdl\n";
