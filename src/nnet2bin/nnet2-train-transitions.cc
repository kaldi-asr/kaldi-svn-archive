// nnet2bin/nnet2-train-transitions.cc
...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "\n"
        "Usage:  nnet2-train-transitions [options] <nnet-in> <alignments-rspecifier> <nnet-out>\n"
        "e.g.:\n"
        " nnet2-train-transitions 1.nnet \"ark:gunzip -c ali.*.gz|\" 2.nnet\n";
