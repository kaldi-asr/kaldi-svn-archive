...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Concatenate two 'raw' neural nets, e.g. as output by nnet2-init or\n"
        "nnet-to-raw-nnet\n"
        "\n"
        "Usage:  raw-nnet2-concat [options] <raw-nnet1-in> <raw-nnet2-in> <raw-nnet-out>\n"
        "e.g.:\n"
        " raw-nnet2-concat nnet1 nnet2 nnet_concat\n";
