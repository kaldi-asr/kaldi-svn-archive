...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "the criterion.\n"
        "Usage:  nnet2-limit-degradation [options] <old-model-in> <new-model-in> <training-examples-in> <model-out>\n"
        "e.g.: nnet2-limit-degradation 1.nnet 2.nnet ark:valid.egs 2new.nnet\n";
