...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "by programs like nnet2-combine (contains a component of type AffineComponentA\n"
        "corresponding to each descendant of AffineComponent in the original net.)\n"
        "\n"
        "Usage:  nnet2-get-preconditioner [options] <model-in> <training-examples-in> <preconditioner-out>\n"
        "\n"
        "e.g.:\n"
