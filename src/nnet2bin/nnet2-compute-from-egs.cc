...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Does the neural net computation, taking as input the nnet2-training examples\n"
        ...
        "\n"
        "Usage:  nnet2-compute-from-egs [options] <raw-nnet2-in> <egs-rspecifier> "
        "<feature-wspecifier>\n"
        "e.g.:  nnet2-compute-from-egs 'nnet-to-raw-nnet final.mdl -|' egs.10.1.ark ark:-\n";
