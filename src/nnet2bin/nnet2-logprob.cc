...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "(note: you can also directly use nnet2-latgen-faster.\n"
        "\n"
        "Usage: nnet2-logprob [options] <model-in> <features-rspecifier> <logprobs-wspecifier>\n"
        "\n"
        "e.g.: nnet2-logprob 1.nnet \"$feats\" ark:- | latgen-faster-mapped ... \n";
