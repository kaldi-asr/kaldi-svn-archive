...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "\n"
        "Usage:  nnet2-combine-a [options] <old-model> <new-model1> <new-model2> ... <new-modelN> <valid-examples-in> <model-out>\n"
        "\n"
        "e.g.:\n"
        " nnet2-combine 1.1.nnet 1.2.nnet 1.3.nnet ark:valid.egs 2.nnet\n";
