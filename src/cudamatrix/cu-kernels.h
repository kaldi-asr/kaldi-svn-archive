 ...
 * CuMatrix
 */
  template<typename Real> inline void cuda_trace(int Gr, int Bl, Real* mat, Real* value, int nR) { KALDI_ERR << __func__ << " Not implemented"; }
 ...
 * CuMatrix 
 */
template<> inline void cuda_trace<float>(int Gr, int Bl, float* mat, float* value, int nR) { cudaF_trace(Gr,Bl,mat,value,nR); }
 ...
 * CuMatrix 
 */
template<> inline void cuda_trace<double>(int Gr, int Bl, double* mat, double* value, int nR) { cudaD_trace(Gr,Bl,mat,value,nR); }
