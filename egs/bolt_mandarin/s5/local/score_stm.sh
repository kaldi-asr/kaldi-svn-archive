...
if [ $stage -le 0 ] ; then
  $cmd LMWT=$min_lmwt:$max_lmwt $dir/scoring/log/score.LMWT.log \
    ...
    rm -rf $dir/score_LMWT/*.filt '&&' \
    local/hubscr07.pl -h rt-stt -l mandarin -m utf-8 -g $data/glm -r $dir/score_LMWT/stm $dir/score_LMWT/${name}.ctm
    # $SortingProgram -h rt-stt -l mandarin -m utf-8 -g $data/glm -r $dir/score_LMWT/stm $dir/score_LMWT/${name}.ctm
