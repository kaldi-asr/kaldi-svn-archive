...
steps/train_deltas.sh --cmd "$train_cmd"\
 3500 30000 data/train_sub3 data/lang exp/tri1_ali exp/tri2 || exit 1;
...
steps/train_lda_mllt.sh --cmd "$train_cmd"\
  5000 90000 data/train data/lang exp/tri2_ali exp/tri3a || exit 1;
...
steps/train_sat.sh --cmd "$train_cmd"\
  5500 90000 data/train data/lang exp/tri3a_ali exp/tri4a || exit 1;
