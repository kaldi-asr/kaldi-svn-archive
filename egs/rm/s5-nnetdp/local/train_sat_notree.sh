...
# fMLLR-adapted features (this version does not re-train the tree). 
# It can be done on top of either LDA+MLLT, or
...
if [ $# != 5 ]; then
  echo "Usage: local/train_sat_notree.sh <#gauss> <data> <lang> <ali-dir> <exp-dir>"
  echo " e.g.: local/train_sat_notree.sh 2500 15000 data/train_si84 data/lang exp/tri2b_ali_si84 exp/tri3b"
...
cp $alidir/tree $dir # Copy the tree..
