...
if [ $# != 4 ]; then
   echo "Usage: steps/kws_index_utt.sh <lang-dir> <decode-dir> <lattices> <exp-dir>"
   echo " e.g.: steps/kws_index_utt.sh data/lang  data/train exp/mono0a/decode/lat.* exp/kws/mono0a"
...
lattice-to-fst --acoustic-scale=$acoustic_scale --lm-scale=$lm_scale ark:$lattices  ark:- |\
  ...
  fstunion-kaldi ark:- |\
  fstrmepsilon |\
  fstdeterminize-kws > $dir/index.fst
