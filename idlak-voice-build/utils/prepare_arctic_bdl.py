...
WAV_DIR = os.path.realpath(os.path.join(SCRIPT_DIR, '../../idlak-data/en/ga/bdl/wav'))
# set directory for data generated by script (scratch data) build id set to '000000'
SCRATCH_DATA_DIR = os.path.realpath(os.path.join(SCRIPT_DIR, '../idlak-scratch/en/ga/bdl/prepare_arctic_bdl/000000'))
