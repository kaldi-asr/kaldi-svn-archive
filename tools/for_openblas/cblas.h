...
float  cblas_sdsdot(const blasint n, const float, const float *x, const blasint incx, const float *y, const blasint incy);
...
void cblas_saxpy(const blasint n, const float, const float *x, const blasint incx, float *y, const blasint incy);
void cblas_daxpy(const blasint n, const double, const double *x, const blasint incx, double *y, const blasint incy);
void cblas_caxpy(const blasint n, const float *, const float *x, const blasint incx, float *y, const blasint incy);
void cblas_zaxpy(const blasint n, const double *, const double *x, const blasint incx, double *y, const blasint incy);
